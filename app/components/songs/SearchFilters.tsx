  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {/* Music Buttons */}
        <button
          onClick={() => handleFilterChange('instrumental', initialValues.instrumental === '1' ? '' : '1')}
          className={`rounded-lg px-4 py-2 text-sm font-medium transition-colors
            ${
        ...
        <button
          onClick={() => handleFilterChange('keyCompatible', initialValues.keyCompatible ? '' : nowPlayingKey || '')}
        ...
        <button
          onClick={() => handleFilterChange('keyMatch', initialValues.keyMatch ? '' : nowPlayingKey || '')}
          disabled={!nowPlayingKey}
          className={`rounded-lg px-4 py-2 text-sm font-medium transition-colors
            ${
        ...
        <button
          onClick={() => handleFilterChange('playable', initialValues.playable !== 'true')}
          className={`rounded-lg px-4 py-2 text-sm font-medium transition-colors
            ${
              initialValues.playable === 'true'
                ? 'border-2 border-green-700 bg-green-100 text-green-700'
                : 'border-2 border-transparent bg-gray-100 text-gray-700 hover:bg-gray-200'
            }`}
        >
